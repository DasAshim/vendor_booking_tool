...
class PortOfLoadingFilterApiView(GenericAPIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            query_dict = {filter_dict.get(key, None): value for key, value in filter_dict.items()
            ...
            return Response({'count':queryset.count(), "total_is_active":total_is_active,"total_inactive":total_inactive   })
